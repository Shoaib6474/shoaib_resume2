						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productdetails-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"productdetails-display": {
								...
								"action": "display",
								"description": "This application shows product details.",
								"title": "Product Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productdetails",
									"url": sap.ui.require.toUrl("productdetails")
								}
							}
						}
					}
